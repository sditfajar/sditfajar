// src/components/pages/FullBeritaSekolah.jsx
const beritaSekolah = [
  {
    id: 3,
    img: '/images/berita-terkini/olahraga.jpg',
    title: 'Senam Pagi hari Jumat dii SDIT Fajarr',
...
export default function FullBeritaSekolah() {
  return (
    <section className="px-4 py-20 mx-auto font-poppins bg-slate-100 lg:py-30 max-w-7xl md:px-6 lg:px-12">
      <div className="container mx-auto max-w-7xl">
        ...
        {/* <div className="flex items-center justify-center py-7">
          <a href="" className="px-10 py-3 text-xs font-medium text-white bg-[#005C8F] rounded-xl hover:bg-[#002141] transition">
            Selengkapnya
          </a>
        </div> */}

        {/* <div className="grid gap-8 md:grid-cols-2">
          {FullBeritaSekolah.map((bukti) => (
