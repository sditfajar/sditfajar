...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      { image: '/images/profil/profil1.png', text: 'BMH Office' },
      { image: '/images/profil/profil1.png', text: 'BMH Office' },
      { image: '/images/profil/profil1.png', text: 'BMH Office' },
      { image: '/images/profil/profil1.png', text: 'BMH Office' },
      { image: '/images/profil/profil1.png', text: 'BMH Office' },
...
export default function CircularGallery({ items, bend = -3, textColor = '#ffffff', borderRadius = 0.22, font = 'bold 30px DM Sans' }) {
